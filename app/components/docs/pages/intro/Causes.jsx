...
const Causes = () => (
  <div className='docs-installation'>
    ...
    <p>
      I founded the Citizen Makers, an informal citizen arts collective questioning technocentric narratives, and help to support community arts groups, such as Yarnbombing Singapore, with pro-bono web design and funding advisory.
    </p>
    <p>
